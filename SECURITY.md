...
Use [GitHub private vulnerability reporting](https://github.com/Beata-Humeniuk/openapi-converter/security/advisories/new).
...
OpenAPI Converter runs locally. It does not make network requests, send telemetry,
